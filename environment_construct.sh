...
GENERATOR_FILE_GLOB="second_with_generator_after_filter.jsonl"
# Save Args
...
GENERATOR_SAVE_NAME="second_with_generator_after_filter.jsonl"
GENERATOR_META_NAME="second_with_generator_after_filter.json"


TRAIN_SAVE_NAME="FORGE_train_data_1385.json"
TRAIN_META_NAME="FORGE_train_data_meta_1385.json"
